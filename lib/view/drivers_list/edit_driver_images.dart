                                    ...
                                    child: Container(
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Container(
                                            child:
                                            controller.selectedIdentityFace1.value!=null && controller.selectedIdentityFace1.value!.path.split('/')!.last.endsWith('.pdf')
                                            ?Padding(
                                             ...
                                             :controller.selectedIdentityFace1.value!=null   
                                                ?Padding(
                                          ...
                                          SizedBox(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                GestureDetector(
                                                    onTap:(){
                                                      if(controller.selectedIdentityFace1.value!=null && controller.selectedIdentityFace1.value!.path.split('/')!.last.endsWith('.pdf'))
                                                      {
                                                      ...
                                                      else if(controller.selectedIdentityFace1.value!=null)
                                                      showDialog(
                                                        context: context,
                                                        builder: ((builder)=>
                                                          AlertDialog(
                                                     ...
                                                     else if(widget.record.identityCardImageFace1.split('?').first.endsWith('.jpg')||
                                                          widget.record.identityCardImageFace1.split('?').first.endsWith('.jpeg')||
                                                          widget.record.identityCardImageFace1.split('?').first.endsWith('.png')
                                                      )
                                                        showDialog(
                                    ...
                                    child: Container(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              child:
                                              controller.selectedIdentityFace2.value!=null && controller.selectedIdentityFace2.value!.path.split('/')!.last.endsWith('.pdf')
                                                  ?Padding(
                                                  padding: EdgeInsets.all(
                                                      10
                                                  ),
                                                  ...
                                                  :controller.selectedIdentityFace2.value!=null
                                                  ?Padding(
                                                padding: const EdgeInsets.all(3.0),
                                                child: Image.file(
                                    ...
                                    child: Container(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              child:
                                              controller.selectedLicenceFace1.value!=null && controller.selectedLicenceFace1.value!.path.split('/')!.last.endsWith('.pdf')
                                                  ?Padding(
                                                  padding: EdgeInsets.all(
                                                      10
                                                  ),
                                                  ...
                                                  :controller.selectedLicenceFace1.value!=null
                                                  ?Padding(
                                                    padding: const EdgeInsets.all(3.0),
                                                    child: Image.file(
                                    ...
                                    child: Container(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              child:
                                              controller.selectedLicenceFace2.value!=null && controller.selectedLicenceFace2.value!.path.split('/')!.last.endsWith('.pdf')
                                                  ?Padding(
                                                  padding: EdgeInsets.all(
                                                      10
                                                  ),
                                                  ...
                                                  :controller.selectedLicenceFace2.value!=null
                                                  ?Padding(
                                                    padding: const EdgeInsets.all(3.0),
                                                    child: Image.file(
                                            ...
                                            SizedBox(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  GestureDetector(
                                                      onTap:(){
                                                        if(controller.selectedLicenceFace2.value!=null && controller.selectedLicenceFace2.value!.path.split('/')!.last.endsWith('.pdf'))
                                                        {
                                                          showDialog(
                                                              context: context,
                                                              builder: (
                                                        ...
                                                        else if(controller.selectedLicenceFace2.value!=null)
                                                          showDialog(
                                                              context: context,
                                                              builder: ((builder)=>
                                                                  AlertDialog(
                                                        ...
                                                        else if(widget.record.licenceImageFace2.split('?').first.endsWith('.jpg')||
                                                            widget.record.licenceImageFace2.split('?').first.endsWith('.jpeg')||
                                                            widget.record.licenceImageFace2.split('?').first.endsWith('.png')
                                                        )
                                                          showDialog(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: ()async{
                                    ...
                                    print(widget.record.driverImage);
                                    print(controller.selectedIdentityFace1.value);
                                    print(controller.selectedIdentityFace2.value);
                                    print(controller.selectedLicenceFace1.value);
                                    print(controller.selectedLicenceFace2.value);
                                    print(controller.selectedMore1.value);
                                    print(controller.selectedMore2.value);
                                    print(controller.selectedMore3.value);
                                    ...
                                    if(controller.selectedIdentityFace1.value !=null){
                                      print('entreeerrr selectedIdentityFace1');
                                    ...
                                    if(controller.selectedIdentityFace2.value !=null){
                                      print('entreeerrr selectedIdentityFace2');
                                    ...
                                    if(controller.selectedLicenceFace1.value !=null){
                                      print('entreeerrr selectedLicenceFace1');
                                    ...
                                    if(controller.selectedLicenceFace2.value !=null){
                                      print('entreeerrr selectedLicenceFace2');
                                    ...
                                    if(controller.selectedMore1.value != null){
                                      print('entreeerrr more1ImageUrl');
                                    ...
                                    if(controller.selectedMore2.value != null){
                                      print('entreeerrr more2ImageUrl');
                                    ...
                                    if(controller.selectedMore3.value != null){
                                      print('entreeerrr more3ImageUrl');
                                    ...
                                    print(identity1ImageURL);
                                    print(identity2ImageURL);
                                    print(licence1ImageURL);
                                    print(licence2ImageURL);
                                    print(more1ImageUrl);
                                    print(more2ImageUrl);
                                    print(more3ImageUrl);
                                      ...
                                      controller.update_driver(
                                        DriverModel(
                                          ...
                                          driverImage: driverImageURL,
                                            ...
                                            identityCardImageFace1: identity1ImageURL,
                                            identityCardImageFace2: identity2ImageURL,
          ...
          child: Container(
              ...
              Row(
                ...
                children: [
                  Container(
                    child:
                    controller.selectedMore1.value!=null && controller.selectedMore1.value!.path.split('/')!.last.endsWith('.pdf')
                        ?Container(
                          padding: EdgeInsets.only(
                            top: 15,
                          ),
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                            onTap:(){
                              if(controller.selectedMore1.value!=null && controller.selectedMore1.value!.path.split('/')!.last.endsWith('.pdf'))
                              {
                                showDialog(
                                    context: context,
                                    builder: (
                                          ...
                                          content: Container(
                                            height: 500,
                                            width: 2500,
                                            child: SfPdfViewer.file(controller.selectedMore1.value!),
                                          ),
                                        )
                                    )
                                );
                              }
                              else if(controller.selectedMore1.value!=null)
                                showDialog(
                                    context: context,
                                    builder: ((builder)=>
                                        AlertDialog(
                              ...
                              else if(widget.record.moreImage1!.split('?').first.endsWith('.jpg')||
                                  widget.record.moreImage1!.split('?').first.endsWith('.jpeg')||
                                  widget.record.moreImage1!.split('?').first.endsWith('.png')
                              )
                                showDialog(
          ...
          child: Container(
              ...
              Row(
                ...
                children: [
                  Container(
                    child:
                    controller.selectedMore2.value!=null && controller.selectedMore2.value!.path.split('/')!.last.endsWith('.pdf')
                        ?Container(
                          padding: EdgeInsets.only(
                            top: 15,
                          ),
