...
class DriverDetails extends StatefulWidget {
  DriverDetails({Key? key, required this.record}) : super(key: key);
                        ...
                        Center(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image:
                                      NetworkImage(widget.record.driverImage),
                                  fit: BoxFit.cover),
                            ),
                          ),
                        ),
                              ...
                              child: DataTable(
                                ...
                                rows: <DataRow>[
                                  ...
                                  DataRow(cells: <DataCell>[
                                    ...
                                    DataCell(Text(':')),
                                    DataCell(Text(widget.record.identityNumber
                                        .toString())),
                                  ]),
                                  DataRow(cells: <DataCell>[
                                    ...
                                    DataCell(Text(':')),
                                    DataCell(Text(
                                        widget.record.phoneNumber.toString())),
                                  ]),
                                  DataRow(cells: <DataCell>[
                                      ...
                                      child: ListView(
                                        ...
                                        children: [
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Container(
                                                    ...
                                                    child: GestureDetector(
                                                      onTap: () {
                                                        if (widget.record.identityCardImageFace1.split('?').first.endsWith(
                                                                '.jpg') ||
                                                            widget.record
                                              ...
                                              Padding(
                                                ...
                                                child: Container(
                                                    ...
                                                    child: GestureDetector(
                                                      onTap: () {
                                                        if (controller.selectedIdentityFace2.value !=
                                                            null &&
                                                            controller
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Container(
                                                    ...
                                                    child: GestureDetector(
                                                      onTap: () {
                                                        if (controller.selectedLicenceFace1.value !=
                                                            null &&
                                                            controller
                                          ...
                                          if (widget.record.moreImage1 != "")
                                            Center(child: moreWidget1()),
                                          if (widget.record.moreImage2 != "")
                                            Center(child: moreWidget2()),
                                          if (widget.record.moreImage3 != "")
                                            Center(child: moreWidget3()),
                                        ],
                                      ),
                                    ),
                                  );
        ...
        Padding(
          ...
          child: Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    child: widget.record.moreImage1!
                                .split('?')
                                .first
                                .endsWith('.jpg') ||
        ...
        Padding(
          ...
          child: Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    child: widget.record.moreImage2!
                                .split('?')
                                .first
                                .endsWith('.jpg') ||
